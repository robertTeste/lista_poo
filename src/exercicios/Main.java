...
public class Main {
   ...
   /* int x;
    ...
    public static void trocarModelo(Carro c) {
        ...
        /*a) O que é impresso?
        O console vai imprimir: Fusca.
        O que é passado: A variável meuCarro não é o objeto, mas um "ponteiro" (endereço) para ele na memória Heap.

        O parâmetro c: Ao chamar o método, o parâmetro c recebe uma cópia desse endereço.

        Por que afeta o original?
        Como meuCarro e c apontam para o mesmo objeto na memória, qualquer alteração feita através de c reflete diretamente no objeto que meuCarro acessa
        */
